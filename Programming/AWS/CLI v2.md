...
## Install v2
Copied from [VVVVVVVVVV](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html):
...
2. Run the following `snap install` command for the AWS CLI.
    ...
    To view the snap repository for the AWS CLI, including additional `snap` instructions, see the [`aws-cli`](https://snapcraft.io/aws-cli) page in the _Canonical Snapcraft website_.
