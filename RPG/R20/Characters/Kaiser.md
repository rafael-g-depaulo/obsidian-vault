...
"\*" significa que tem proficiência
...
**Levantar Guarda.** Movement Action (1PM): Gain (CONS+2) 4 temporary HP. While you have this temporary HP, you're considered as "On Guard". When you lose this temporary HP by taking damage, gain +1 Guts until the end of the scene.
...
**Aguenta!**: Movimento (1PM): +2 Guard pela cena.
...
- **Lança.** Dano: 1d12 perfurante. crit 20/x2. mounted (2-handed). reach +1sqr.
	- **Runa (Dano Cortante)**: 1PM per Charge (max 4)	(Movement, 1 Charge): Change the damage type to bludgeoning (impacto) for the scene
...
Origin: Brute (+2 STR, +1 CON, -1 SEN), **Aguenta!**

#### Level 2
Feat: **Defesa Impenetrável**
...
- **Defesa Implacável**. Ao Levantar Guarda (+1PM): Você pode pode usar [[Combat Actions#Endurance]] como ação livre, sem custo adicional. Pré-requisito: Defesa Impenetrável,  Defesa Impenetrável.
