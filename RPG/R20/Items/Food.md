...
- Os materiais necessários são mantimentos comuns (ver: [[Rations]]), mas para certos itens de alto nível o mestre pode requer que certos itens ou temperos especiais e raros sejam usados como parte dos materiais para uma **Comida Especial** (a critério do mestre).
